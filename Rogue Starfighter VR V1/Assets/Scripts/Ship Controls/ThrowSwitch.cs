...
namespace Valve.VR.InteractionSystem
{
	...
	{
		public Hand.AttachmentFlags attachmentFlags = Hand.AttachmentFlags.DetachFromOtherHand; // Added
		...
		private void HandHoverUpdate( Hand hand )
        {
            ...
            {
				hand.AttachObject(gameObject, startingGrabType, attachmentFlags); // Added
			...
			{
				hand.DetachObject(gameObject); // Added
